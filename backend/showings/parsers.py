...
class TajParser:
    ...
    def parse_titles_from_titles_page(titles_page: bytes) -> list:
        ...
        try:
            ...
            movie_containers = movies_container.find_all('div', class_='prs_upcom_movie_content_box')
    ...
    def parse_showing_dates_from_title_page(title_page: bytes):
        try:
            ...
            parsed_showing_dates = [{'date': i.text, 'date_id': i.attrs.get('href')} for i in day_components]
    ...
    def parse_showings_from_title_page(title_showings_page: str) -> list:
        ...
        try:
            ...
            for l in locations:
                ...
                for s in sessions:
                    session_timestamp = datetime.datetime.strptime(s['datetime'], '%Y-%m-%dT%H:%M:%S')
