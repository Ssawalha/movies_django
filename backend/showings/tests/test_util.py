...
class TestUtil(unittest.TestCase):
    ...
    def test__get_first_non_empty(self):
        ...
        expected = '1yts'
        self.assertEqual(expected, get_first_non_empty(title_a.get('prime_id'), title_b.get('prime_id')))
        self.assertEqual(expected, get_first_non_empty(title_b.get('prime_id'), title_a.get('prime_id')))
...
class TestMovieTitleMatching(unittest.TestCase):
    ...
    def test_handle_perfect_match_titles__merges_empty_titles(self):
        ...
        merged_titles = handle_perfect_match_titles(grand_titles, prime_titles, taj_titles)
    ...
    def test_handle_perfect_match_titles__merges_titles_when_no_matches_found(self):
        ...
        grand_titles = [{'title': '   The Matrix ', 'grand_id': '1abc'}]
        prime_titles = [{'title': 'ALIEN 5', 'prime_id': 'ahd2'},]
